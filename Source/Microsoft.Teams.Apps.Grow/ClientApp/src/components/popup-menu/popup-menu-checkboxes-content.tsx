...
import { Flex, Input, Button, Provider } from "@fluentui/react-northstar";
			...
			<div className="content-items-wrapper">
				...
				<div className="content-items-headerfooter">
					<Flex gap="gap.small" vAlign="center" hAlign="end">
						...
						<Button icon={<CloseIcon />} size="small" text onClick={() => deSelectAll()} content={localize("unselectedAll")} />
					</Flex>
				</div>
			</div>
		</Provider>
