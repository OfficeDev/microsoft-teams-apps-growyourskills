...
namespace Microsoft.Teams.Apps.Grow.Authentication
{
    using System;
    ...
    public static class AuthenticationServiceCollectionExtensions
    {
        ...
        public static void AddGrowAuthentication(this IServiceCollection services, IConfiguration configuration)
        {
